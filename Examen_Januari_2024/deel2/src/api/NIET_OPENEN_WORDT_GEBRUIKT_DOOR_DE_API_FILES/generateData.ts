...
export const MOVIE_KEY = 'movies__exam'
export const CINEMA_KEY = 'cinemas__exam'
export const ACTOR_KEY = 'actors__exam'
export const WRITER_KEY = 'writers__exam'
export const DIRECTOR_KEY = 'directors__exam'
...
export function getRandomUnusedMovie(): IMovie {
    const usedMovies = new Set<string>((JSON.parse(localStorage[MOVIE_KEY]) as IMovie[]).map(m => m.id))
